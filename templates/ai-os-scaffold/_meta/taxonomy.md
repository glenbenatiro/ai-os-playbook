...
## Identity
- `me` — the owner's own person note.

## Sensitivity {{TAXONOMY_PRIVACY}}

## Status / signal
- `to-confirm` — companion tag for notes holding unverified facts (mirrors `provenance: to-confirm`).

<!-- Add domain tags below as the vault grows (people roles, project areas, tools categories). -->
