...
9. Convert relative dates to absolute. Use ISO dates (`YYYY-MM-DD`). {{OWNER_SHORT}}'s working window for
...
`.trash/`, rebuilding the `index.md` files + MOCs, and regenerating `_insights.md`. It also keeps the vault
